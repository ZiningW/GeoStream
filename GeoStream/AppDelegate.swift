...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        ...
        let ref = Database.database().reference().child("UserBase")
        //        let ref = Database.database().reference().child("TestGroup")
        let selfUserUid: String = Auth.auth().currentUser?.uid ?? "None"
